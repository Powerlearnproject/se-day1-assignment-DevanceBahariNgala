...
Waterfall: Sequential approach with distinct phases (e.g., requirements, design, implementation) flowing downwards like a waterfall. examples of waterfall methdologies include Development of Department Of Defense (DOD), military and aircraft programs followed Waterfall model in many organizations.This is because of the strict standards and requirements that have to be followed.
  
Agile: Iterative and incremental approach focused on flexibility, collaboration, and responding to change. an example of agile methodology includes a start-up developing a new mobile app can benefit from Agile by rapidly iterating on user feedback and releasing updates frequently to stay competitive
...
Prompt engineering is all about crafting questions or statements to get the best possible responses from AI models. The importance of prompt engineering helps avoid asking vague questions and getting condusing answers therefore by making your questions clear and specific, the AI understands exactly what you need and gives you correct answers.
...
Improved Prompt example: Tell me about german shephered dog breed?

The improved prompt is more efective because its clear,specific and concise it uses keywords that guides the AI towards the kind of response an individual wants. 
